...
var GitHubEventCtrl = require('./controllers/GitHubEventCtrl');
...
app.post('/githubEvent', GitHubEventCtrl.post);
...
// Jobs
app.get('/jobs/:jobId', loggedIn, JobCtrl.get);
app.get('/repos/:repoId/jobs', loggedIn, JobCtrl.allForRepoId);


app.get('/', MainCtrl.get);
